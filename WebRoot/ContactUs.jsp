...
<table  border="0" align="center"  bgcolor="white" width="80%">              <tr>
        ...
        <pre><h1> <u>address:</u></h1>
             <h3><em>Area Name:Kanpur(UP)    <br>                 Branch Name : ECE <br>                 Web Site Link: <br>                 Contact Number: 134568</em><br>
                 </h3></pre>
